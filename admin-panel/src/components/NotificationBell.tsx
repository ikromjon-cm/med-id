  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="relative w-10 h-10 rounded-xl flex items-center justify-center text-gray-500  hover:bg-gray-100  hover:text-gray-700  transition-all"
      >
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 ">
                ...
                <span className="text-xs text-gray-500 ">{notifs.length} {t('total')}</span>
              </div>
