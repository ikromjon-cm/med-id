  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{t('View and manage your appointments')}</p>
      </div>
          ...
          <div className="divide-y divide-gray-100 dark:divide-gray-800/30">
            {currentList.map((apt, idx) => (
              ...
              >
                ...
                <div className="w-px h-12 bg-gray-200 dark:bg-gray-700/50 flex-shrink-0" />
