    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 ml-9">Monitor and manage emergency alerts</p>
        </div>
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <span className="flex items-center gap-1.5"><AlertTriangle className="w-4 h-4" /> Active ({activeCount})</span>
        </button>
        <button
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description={showResolved ? 'There are no emergency alerts.' : 'All emergencies have been resolved.'}
          action={showResolved ? undefined : { label: 'Show All', onClick: () => setShowResolved(true) }}
        />
      ) : (
