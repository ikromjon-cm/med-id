    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {loading ? (
          ...
          <>
            <ChartCard title="Users Growth" subtitle="Monthly growth over the last 12 months" className="lg:col-span-2">
              <ResponsiveContainer width="100%" height={350}>
                <LineChart data={userGrowth}>
                  ...
                  <Line type="monotone" dataKey="users" stroke="#0F6FFF" strokeWidth={2.5} dot={{ fill: '#0F6FFF', r: 4 }} activeDot={{ r: 6 }} name="Total Users" />
                  <Line type="monotone" dataKey="patients" stroke="#00C896" strokeWidth={2.5} dot={{ fill: '#00C896', r: 4 }} name="Patients" />
                  <Line type="monotone" dataKey="doctors" stroke="#FFB020" strokeWidth={2.5} dot={{ fill: '#FFB020', r: 4 }} name="Doctors" />
                </LineChart>
              </ResponsiveContainer>
            </ChartCard>

            <ChartCard title="Emergency Access" subtitle="Emergency vs Routine access patterns">
              <ResponsiveContainer width="100%" height={300}>
                <AreaChart data={emergencyAccess}>
                  ...
                  <YAxis tick={{ fontSize: 12 }} stroke="#9ca3af" />
                  <Tooltip contentStyle={{ backgroundColor: 'rgba(255,255,255,0.9)', backdropFilter: 'blur(10px)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.2)' }} />
                  <Area type="monotone" dataKey="emergency" stroke="#FF4D4F" strokeWidth={2} fill="url(#eaEmergency)" name="Emergency" />
                  <Area type="monotone" dataKey="routine" stroke="#0F6FFF" strokeWidth={2} fill="url(#eaRoutine)" name="Routine" />
                </AreaChart>
              </ResponsiveContainer>
            </ChartCard>
            ...
            <ChartCard title="Role Distribution" subtitle="User distribution by role">
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
            ...
            <ChartCard title="Monthly Active Users" subtitle="Active users per month" className="lg:col-span-2">
              <ResponsiveContainer width="100%" height={300}>
