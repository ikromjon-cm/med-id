    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500  mt-1">{t('Full history of emergency access events')}</p>
        </div>
        <motion.button
      ...
      {loading ? (
        ...
        <div className="glass-card rounded-2xl overflow-hidden">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-100 ">
                  <th className="px-6 py-3.5 text-left text-xs font-semibold text-gray-500  uppercase tracking-wider">{t('Patient')}</th>
                  <th className="px-6 py-3.5 text-left text-xs font-semibold text-gray-500  uppercase tracking-wider">{t('Accessed By')}</th>
                  <th className="px-6 py-3.5 text-left text-xs font-semibold text-gray-500  uppercase tracking-wider">{t('Access Type')}</th>
                  <th className="px-6 py-3.5 text-left text-xs font-semibold text-gray-500  uppercase tracking-wider">{t('Timestamp')}</th>
                ...
                {filtered.map((log, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-3.5">
                        <span className="text-sm text-gray-700 ">{log.accessType}</span>
                      </td>
                      <td className="px-6 py-3.5">
          ...
          <div className="px-6 py-3 border-t border-gray-100 ">
            <p className="text-xs text-gray-500 ">{filtered.length} {t('log entry')}{filtered.length !== 1 ? 's' : ''}</p>
          </div>
        </div>
      )}
    </div>
