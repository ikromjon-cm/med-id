...
const STATUS_FILTERS = [t('All'), 'GRANTED', 'DENIED', 'PENDING'];
    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description={search || statusFilter !== 'All' || startDate ? t('Try adjusting your filters.') : t('No emergency access logs recorded yet.')}
        />
      ) : (
