  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 ">{t('Doctor Management')}</h2>
          <p className="text-sm text-gray-500  mt-1">{t('Manage and monitor all doctors across clinics')}</p>
        </div>
        <motion.button
