  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <StatCard
            ...
            subtitle={t('+156 this month')}
            color="primary"
            delay={0}
          />
          <StatCard
            title={t('Active Doctors')}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {loading ? (
          ...
          <>
            ...
            <ChartCard title={t('Emergency Access')} subtitle={t('Emergency vs Routine access frequency')}>
              <ResponsiveContainer width="100%" height={300}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {loading ? (
          ...
          <>
            ...
            <ChartCard title={t('Role Distribution')} subtitle={t('Users by role')}>
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie
                    data={roleDist}
      ...
      {loading ? (
        ...
        <ChartCard title={t('Recent Activity')} subtitle={t('Latest platform activities')}>
